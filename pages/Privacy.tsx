  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 t-text-2 leading-relaxed">
        <section>
          <h2 className="text-2xl font-bold t-text mt-8 mb-4">1. Information We Collect</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold t-text mt-8 mb-4">2. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold t-text mt-8 mb-4">3. Data Storage & Security</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold t-text mt-8 mb-4">4. Cookies & Tracking</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold t-text mt-8 mb-4">5. Third-Party Services</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold t-text mt-8 mb-4">6. Your Rights</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold t-text mt-8 mb-4">7. Contact</h2>
