      ...
      <div className="flex animate-marquee items-center gap-16 min-w-full px-4 text-sm font-bold t-text-2 uppercase tracking-[0.2em]">
        {[...Array(6)].map((_, i) => (
          <React.Fragment key={i}>
            <span className="flex items-center gap-3 t-text hover:t-text transition-colors"><Users size={18} className="text-brand-500" /> 10,000+ Students</span>
            <span className="t-text-3">/</span>
            <span className="flex items-center gap-3 t-text hover:t-text transition-colors"><Trophy size={18} className="text-yellow-400" /> Creators &amp; Influencers Academy #1</span>
            <span className="t-text-3">/</span>
            <span className="flex items-center gap-3 t-text hover:t-text transition-colors"><Globe size={18} className="text-blue-400" /> 50+ Countries</span>
            <span className="t-text-3">/</span>
          </React.Fragment>
        ))}
      </div>
