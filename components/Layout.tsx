  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 flex flex-col font-sans selection:bg-brand-100 selection:text-brand-900">
      ...
      <nav className="sticky top-0 z-50 border-b border-neutral-100 bg-white/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-12">
              <Link to="/" className="flex-shrink-0 z-50 relative flex items-center gap-2 group">
              ...
              <div className="hidden md:block">
                <div className="flex items-baseline space-x-8">
                  <Link to="/" className="text-neutral-600 hover:text-black font-medium transition text-sm">All Courses</Link>
                  <a href="https://youtube.com/@eyebuckz" target="_blank" rel="noreferrer" className="text-neutral-600 hover:text-[#FF0000] font-medium transition text-sm flex items-center gap-1">
                    YouTube
                  </a>
                  {user && (
                    <Link to="/dashboard" className="text-neutral-600 hover:text-black font-medium transition text-sm">My Learning</Link>
                  )}
                  {isAdmin && (
                    <Link to="/admin" className="text-brand-600 hover:text-brand-700 font-medium flex items-center gap-1 transition text-sm">
              ...
              <div className="ml-4 flex items-center md:ml-6 gap-4">
                {user ? (
                  <div className="flex items-center gap-4">
                    ...
                    <div className="h-10 w-10 rounded-full bg-neutral-100 border border-neutral-200 flex items-center justify-center shadow-sm">
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                className="z-50 relative inline-flex items-center justify-center p-2 rounded-md text-neutral-600 hover:text-black focus:outline-none"
              >
        ...
        {/* Mobile menu Overlay */}
        {isMenuOpen && (
          <div className="fixed inset-0 z-40 bg-white md:hidden pt-24 px-6 animate-fade-in flex flex-col h-screen">
             <div className="flex flex-col space-y-2">
                <Link to="/" className="flex items-center justify-between p-4 rounded-xl bg-neutral-50 hover:bg-neutral-100 transition border border-neutral-100">
                    <span className="text-lg font-medium">Browse Courses</span>
                    <ChevronRight size={20} className="text-neutral-400" />
                </Link>
                
                 <a href="https://youtube.com/@eyebuckz" target="_blank" rel="noreferrer" className="flex items-center justify-between p-4 rounded-xl bg-neutral-50 hover:bg-neutral-100 transition border border-neutral-100">
                    <span className="text-lg font-medium flex items-center gap-2"><Youtube size={20} className="text-red-600"/> YouTube Channel</span>
                    <ChevronRight size={20} className="text-neutral-400" />
                </a>

                {user && (
                  <Link to="/dashboard" className="flex items-center justify-between p-4 rounded-xl bg-neutral-50 hover:bg-neutral-100 transition border border-neutral-100">
                ...
                {isAdmin && (
                  <Link to="/admin" className="flex items-center justify-between p-4 rounded-xl bg-brand-50 hover:bg-brand-100 transition border border-brand-200 text-brand-600">
                      <span className="text-lg font-medium flex items-center gap-2"><ShieldAlert size={18} /> Admin Panel</span>
